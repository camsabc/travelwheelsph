    ...
    <div className="d-flex flex-column vh-100" style={{ backgroundColor: '#ffffff' }}>
      ...
      <MDBContainer className="flex-grow-1 py-5">
        ...
        <div className="text-center mb-4">
          <h2 style={{ fontWeight: 'bolder', paddingBottom: '10px', color: 'rgb(61, 132, 185)' }}>PAST BOOKINGS</h2>
        ...
        {quotations.slice().reverse().length > 0 ? (
          ...
          <div className="text-center" style={{ padding: '20px', fontSize: '1.25rem', fontWeight: 'bold' }}>No past booking found.</div>
        )}
      </MDBContainer>
