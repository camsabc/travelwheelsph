                ...
                <MDBModalContent>
                    ...
                    <MDBModalBody>
                        ...
                        <MDBCol md="6">
                          ...
                          <p style={{ marginBottom: '5px' }}>Company Name: {bookingDetails.companyname}</p>
                          <p style={{ marginBottom: '5px' }}>Company Address: {bookingDetails.companyaddress}</p>
                          <p style={{ marginBottom: '5px' }}>Contact Person: {bookingDetails.contactperson}</p>
